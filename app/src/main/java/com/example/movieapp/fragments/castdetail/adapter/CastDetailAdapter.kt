package com.example.movieapp.fragments.castdetail.adapter
...
class CastDetailAdapter(private val mList: List<MovieItem>) : RecyclerView.Adapter<CastDetailAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_cast_movie_list, parent, false)
